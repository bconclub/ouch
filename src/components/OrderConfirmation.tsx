...
export function OrderConfirmation({
  ...
  total: number
  whatsappUrl: string
  /** False until the business number exists — the link is email instead. */
  onWhatsApp?: boolean
}) {
  return (
    <>
      ...
      <div className="mt-8 text-center">
        <p className="mb-4 text-sm text-muted">
          {onWhatsApp
            ? 'Last step, promise — send us your order and we’ll sort payment and delivery right there in chat. Easy peasy, lemon squeezy.'
            : 'Last step, promise — send us your order and we’ll sort payment and delivery by email. Easy peasy, lemon squeezy.'}
        </p>
        <a
          className={`inline-flex items-center gap-3 rounded-full px-8 py-4 text-sm font-bold tracking-widest transition-opacity hover:opacity-90 ${
        ...
        >
          ...
          {onWhatsApp ? 'Complete on WhatsApp' : 'Send us your order'}
        </a>
        <div className="mt-8">
