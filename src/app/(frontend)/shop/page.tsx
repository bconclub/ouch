...
export default async function ShopPage({
  ...
  const query: ProductQuery = {
    ...
    excludeCategory: first(params.category) ? undefined : ['posters', 'bookmarks'],
  }
    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      ...
      <div className="mb-8 rounded-2xl border border-line p-5">
        ...
        <p className="mt-2 text-sm opacity-80">
          Wondering what fits your piercing? Send us a photo on WhatsApp — we&apos;ll tell you
      ...
      <Suspense>
        <ShopFilters
          categories={categories
            .filter((c) => c.slug !== 'posters' && c.slug !== 'bookmarks')
